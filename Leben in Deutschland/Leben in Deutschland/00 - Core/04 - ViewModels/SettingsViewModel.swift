...
class SettingsViewModel: ObservableObject {
    ...
    enum UpdateAlertType: Equatable {
        case latest
        case available
        case required
    }
    ...
    @Published var updateAlertType: UpdateAlertType?
    ...
    func showTestAlert() {
        ...
        case 0:
            updateAlertType = .latest
        case 1:
            updateAlertType = .available
        case 2:
            updateAlertType = .required
        default:
            updateAlertType = .latest
        }
